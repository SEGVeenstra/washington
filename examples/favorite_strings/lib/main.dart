...
void main() {
  ...
  final stringsRepository =
      FavoritableStringsRepository(stringsLocalDataSource);

  GetIt.I.registerFactory<AllStringsState>(
      () => AllStringsState(stringsRepository));
  GetIt.I.registerFactory<FavoriteStringsState>(
      () => FavoriteStringsState(stringsRepository));
